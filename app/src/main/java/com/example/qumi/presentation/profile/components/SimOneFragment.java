...
public class SimOneFragment extends Fragment {
    ...
    public SimOneFragment() {
    }

    public static SimOneFragment newInstance(String param1, String param2) {
        SimOneFragment fragment = new SimOneFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_sim_one, container, false);
        linkWithId();
        init();
        balanceTracker();
    ...
    private void linkWithId() {
        circularProgressBar=view.findViewById(R.id.pb_tracker1);
