...
public class ServiceFragment extends Fragment {
    ...
    private void fillRecyclerView() {
        ...
        serviceRecyclerView.setAdapter(chatRecyclerViewAdapter);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
            serviceRecyclerView.setOnScrollListener(new CustomScrollListener(getActivity()));
    }
    ...
    private void linkWithId() {
        serviceRecyclerView=view.findViewById(R.id.rv_services);
    }
}